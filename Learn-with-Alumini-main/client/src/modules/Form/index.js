...
const Form = ({
    isSignInPage = true,isStudent = true
}) => {
  ...
  return (
    <div className="bg-light h-screen flex items-center justify-center">
        ...
        <div class="text-4xl font-extrabold flex items-center justify-center mt-13">Hello {isStudent ? "Student" : "Alumini"}!</div>
