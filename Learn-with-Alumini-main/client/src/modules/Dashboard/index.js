...
const Dashboard = ({isStudent = true}) => {
	...
	return (
		<div className='w-screen flex'>
			<div className='w-[25%] h-screen bg-secondary overflow-scroll'>
				<div className='flex items-center my-8 mx-14'>
					...
					<div className='ml-8'>
						...
						<p className='text-lg font-light'>Hello {isStudent ?'Student' : 'Alumini'}</p>
						{isStudent ? null :<button onclick = {console.log(121)} className="font-inter font-medium bg-[red] text-white px-4 py-2 rounded-md absolute bottom-3 right-3"><Link to="/CreditCardForm">Contribute</Link></button>}
						{/* <buton onClick={() => props.onFormSwitch("Chat App\client\src\paymentGateway\index.js")} className="font-inter font-medium bg-[red] text-white px-4 py-2 rounded-md absolute bottom-3 right-3">Contribute</button> */}

						{/* <link to="/paymentGateway/index.js" className="font-inter font-medium bg-[#f04343] text-white px-4 py-2 rounded-md fixed bottom-3 rightcd-3">Contribute</link> */}
					</div>
				</div>
				<hr />
				<div className='mx-14 mt-10'>
					<div className='text-primary text-lg'>{isStudent ? 'Replies' : 'Requests'}</div>
					<div>
						{
							conversations.length > 0 ?
								...
								}) : <div className='text-center text-lg font-semibold mt-24'>{isStudent ? 'Be First to Chat with Alumini' : 'Guide Students for thier future'}</div>
						}
					</div>
				</div>
			</div>
			...
			<div className='w-[25%] h-screen bg-light px-8 py-16 overflow-scroll'>
				<div className='text-primary text-lg'>{isStudent ? 'Alumini' : 'Students'}</div>
				<div>
					{
						users.length > 0 ?
				...
				<Link to="/users/sign_in" className="font-inter font-medium bg-[#6469ff] text-white px-4 py-2 rounded-md absolute top-3 right-3">signout</Link>
